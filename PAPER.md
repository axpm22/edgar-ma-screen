...
> ## ⚠ SUPERSEDED — body text below is pre-2026-08-04
>
> The panel was extended from 2016 to **2012** and every headline recomputed on
> **eleven** test years instead of three. The body of this paper has NOT yet
> been rewritten; treat `README.md` and `docs/STRESS_RESULTS.md` as current and
> this file as a draft pending revision.
>
> | | This paper says | Current |
> |---|---|---|
> | Target, operating cos | 10.73% / 6.42×, 3 years | **12.28% / 6.91×, 11 years** |
> | Buyer, operating cos | not reported | **31.72% / 12.21×** |
> | Company-weeks | 4,123,449 | **5,967,094** |
> | Companies | 15,325 | **19,021** |
> | Deal filings | 2,456 | **3,188** |
> | Verified targets | 1,664 | **2,227** |
> | XBRL facts | 2,041,665 | **5,249,647** |
> | Form events | 1,167,814 | **2,025,920** |
>
> Three claims in the body are now known to be wrong:
> **(a)** SPAC exclusion does not cost "a third of the apparent skill" — it
> moves precision ~1pp and lift ~0.
> **(b)** Precision is not comparable across years. Deal base rates halved over
> the panel; lift is the base-rate-invariant measure and it is flat.
> **(c)** The tender-offer validation is uninformative, not supportive: it
> rests on 1–5 distinct companies a year.
